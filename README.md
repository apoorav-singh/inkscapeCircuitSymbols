...
- In case you are using LaTeX (MikTeX). Open MikTeX console and select settings. You may select "Always" to install any missing packages automatically (as shown in the image below) if needed run the plugin.
